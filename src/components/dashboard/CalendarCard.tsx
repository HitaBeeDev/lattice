...
export default function CalendarCard({
  ...
  return (
    <div
      className="rounded-[1.2rem] bg-[#cee2e9]/40 p-5 cursor-pointer transition-colors h-full
       duration-200 hover:bg-[#cee2e9]/55 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0a1929]/20"
      role="link"
      tabIndex={0}
